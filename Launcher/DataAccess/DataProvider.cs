...
namespace DataAccess
{
    ...
    {
        public static string _serverString = @"Server=FW-DP02\KADENCE;User Id=sa;
Password=dkcnyh20081992;";
        ...
        public static DataSet Excute(RequestCollection requests)
        {
            ...
            try
            {
                var connectString = string.Format(@"Server={0};User Id=sa;
Password=dkcnyh20081992;", DataProvider.ReadFromConfigXMlFile("ServerName"));
