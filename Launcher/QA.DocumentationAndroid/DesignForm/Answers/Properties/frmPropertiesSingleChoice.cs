...
{
    public partial class frmPropertiesSingleChoice : ClientForm
    {
        public frmPropertiesSingleChoice()
        {
            InitializeComponent();
        }

        public string SingleChoice_View_Answer_AnswerText { get { return txtAnswerText.Text.Trim(); }
            set {
                txtAnswerText.Text = value;
            }
        }
        public string SingleChoice_View_Answer_AnswerIndex
        {
            get { return ConvertSafe.ToString(lblAnswerIndex.Text); }
            set { lblAnswerIndex.Text = value; }
        }
        public string SingleChoice_View_Answer_AnswerCodes_VariableName {
            get { return txtAnswerCodesVariablesName.Text.Trim(); }
            set {
                txtAnswerCodesVariablesName.Text = value; }
        }
        public string SingleChoice_View_Answer_AnswerCodes_UnCheckedCode {
        ...
        public string SingleChoice_View_Answer_AnswerCodes_CheckedCode
        {
        ...
        public string SingleChoice_View_Answer_AnswerCodes_OtherSpecify {
            get { return chkOther.Checked.ToString(); }
            set { chkOther.Checked =ConvertSafe.ToBoolean( value); }
        }
        public string SingleChoice_View_Answer_AnswerCodes_OtherSpecify_VariableName
        {
            get { return txtOtherVariableName.Text.Trim(); }
            set { txtOtherVariableName.Text = value; }
        }
        public string SingleChoice_View_Answer_AnswerCodes_OtherSpecify_InType
        {
        ...
        public string SingleChoice_View_Answer_AnswerCoding { get { return txtCoding.Text.Trim(); } set { txtCoding.Text = value; } }
    }
}
