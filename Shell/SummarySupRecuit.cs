...
namespace Shell
{
    public partial class SummarySupRecuit : ClientControl
    {
        public SummarySupRecuit()
        {
            InitializeComponent();
        }
        ...
        public void LoadQuota()
        {
            ...
            //2
            query += DataAccess.DataQuery.Create("Docs", "ws_DOC_Answers_ListCalculateQuotaRecuit", new
            {
                ProjectID
            });
            //3
            ...
            gridControl1.Populate(ds.LastTable());
        }
